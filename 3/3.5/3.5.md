...
**Título:**  
Elección entre AWS API Gateway y Kong API Gateway para la Arquitectura General de Turi
...
### Decisión 1: Elección de Node.js con PostgreSQL para el Backend
...
### Decisión 2: Uso de Filtrado Avanzado para Reportes Financieros
...
### Decisión 2: Uso de Node.js con PostgreSQL vs .NET con MongoDB para el Backend
