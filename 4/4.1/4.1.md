...
| **Cod Escenario** | **Atributo de Calidad** | **Estímulo** | **Fuente del Estímulo** | **Artefacto** | **Entorno** | **Respuesta**| **Medida de Respuesta**|
|----------|------------------|----------------------------------------|-------------------------|--------------------------------|-------------------------------------|-------------------------------------------------------------|-----------------------------------------------------|
| ESC-03 | Disponibilidad | Caída de conexión a la base de datos | Base de datos  | Módulo de Blog | Operación normal con actividad moderada| El sistema sigue permitiendo la visualización de publicaciones y comentarios recientes | Disponibilidad del 99.9% en la recuperación de datos |
...
| **Cod Escenario** | **Atributo de Calidad** | **Estímulo**                              | **Fuente del Estímulo** | **Artefacto**                    | **Entorno**                              | **Respuesta**                                      | **Medida de Respuesta**                             |
|------------------|-------------------------|-------------------------------------------|-------------------------|----------------------------------|------------------------------------------|---------------------------------------------------|-----------------------------------------------------|
| ESC-04           | Disponibilidad           | Aumento súbito en la carga de usuarios    | Campaña publicitaria     | Módulo de Autenticación          | Operación durante un evento de marketing | El sistema puede manejar picos de usuarios sin degradar el servicio. | El sistema mantiene una disponibilidad del 99.9% anual |
...
| **Cod Escenario** | **Atributo de Calidad** | **Estímulo**                    | **Fuente del Estímulo**  | **Artefacto**                     | **Entorno**                       | **Respuesta**                                             | **Medida de Respuesta**                             |
|------------------|-------------------------|---------------------------------|--------------------------|-----------------------------------|-----------------------------------|---------------------------------------------------------|-----------------------------------------------------|
| ESC-05           | Disponibilidad           | Fallo en el servidor de autenticación | Hardware defectuoso      | Módulo de Autenticación           | Operación en horario laboral      | El sistema debe poder recuperar la funcionalidad rápidamente. | El sistema debe recuperar la funcionalidad en menos de 5 minutos. |
