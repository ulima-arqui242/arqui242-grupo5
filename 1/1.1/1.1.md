...
INTERNOS:
- Administrador de red: Garantizar que el blog sea accesible y funcione sin interrupciones.
- Arquitecto: Asegurar que la arquitectura del módulo soporte la carga multimedia.
- Diseñador: Asegurar que el diseño del blog sea atractivo y fácil de navegar, manteniendo una buena experiencia de usuario.
- Responsable de mantenimiento: Corregir errores que surjan durante el uso del blog.
- Administrador de Base de Datos: Mantener las bases de datos de Turi, asegurando su rendimiento, seguridad y disponibilidad.
- Evaluador: Realizar pruebas exhaustivas, y verificar que se cumplan los requerimientos técnicos

EXTERNOS:
- Usuarios: Permitir crear y compartir contenido.
- Clientes: Promocionar destinos turísticos, creando publicaciones y utilizando hashtags para aumentar la visibilidad.
- Socios estratégicos: Lograr fomentar la atracción de más visitantes. s
