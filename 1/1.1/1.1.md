...
### 4.1 Ver reporte de ingresos por organización
...
### 4.2 Cobro por comisión en las ventas/reservas
- A través de esta función, las organizaciones pueden gestionar y aplicar comisiones a las ventas y reservas realizadas en la plataforma. Esto permite un control eficiente y preciso de los ingresos, asegurando que las comisiones sean calculadas y cobradas de manera adecuada.
